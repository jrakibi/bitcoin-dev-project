...
const MultisigAnimation: React.FC = () => {
    ...
    return (
        <div
            className={`mx-auto py-1 -mx-4 sm:-mx-8 md:-mx-16 lg:-mx-32 xl:-mx-40 ${isFullscreen ? "fixed inset-0 z-50 bg-[#272E35] overflow-auto" : ""}`}
        >
            <div
                className={`mx-auto py-4 ${isFullscreen ? "w-full h-full" : "w-full max-w-7xl"}`}
                ref={containerRef}
            >
                <div className="w-full bg-[#272E35] rounded-lg overflow-hidden">
                    <div className="bg-[#454C54] p-4 flex flex-wrap justify-between items-center text-sm">
                    ...
                    <div className="p-4 sm:p-8 relative">
                        ...
                        <div
                            ...
                            style={{
                                width: `${Math.min(numParticipants * 192 + (numParticipants - 1) * 48, 100)}%`,
                                maxWidth: "100%"
                            }}
                        >
                            <MultisigWallet
...
const MultisigWallet: React.FC<{
    ...
    <div
        className={`relative w-full h-24 sm:h-36 mx-auto border-2 border-[#454C54] rounded-lg p-2 sm:p-4 transform transition-all duration-300 ${
...
const Participant: React.FC<{
    ...
    <div
        className={`bg-[#E5E6F1] rounded-lg shadow p-4 sm:p-6 text-center w-full sm:w-48 ${
